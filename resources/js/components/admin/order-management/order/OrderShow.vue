        	...
        	<div class="col-md-12">
        		<div class="bg-white p-3 mb-4 border rounded">
        			...
        			<ul class="list-unstyled d-flex ul-step mb-0">
		                ...
		                <li class="rounded px-3 py-2 me-3 border-3 position-relative" :class="order.status >= 5 ? 'text-center text-dark border-bottom border-success  bg-light-green' : 'bg-light text-secondary border-bottom fw-light'">
        	...
        	<div class="col-md-5">
        		<div class="rounded border bg-white p-3">
        			<table class="table table-striped fs-6 mb-0 "> 
        				<tbody>
        				<tr><th class="py-1 py-2">Client: </th><td class="ps-2">{{ order.infouser.name }}</td></tr>
        				<tr><th class="py-1 py-2">Email: </th><td class="ps-2">{{ order.infouser.email }}</td></tr>
        				<tr><th class="py-1 py-2">Date inscription: </th><td class="ps-2">{{ order.infouser.created_at }}</td></tr>
        			</tbody>
        			</table>
        			
        		</div>

        		<div class="rounded border bg-white p-3 mt-4  bottom-30-xs">
        			<h5>Journal</h5>
        			<table class="table table-striped fs-6 mb-0 ">
        				<thead>
